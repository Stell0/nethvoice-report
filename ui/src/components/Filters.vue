    ...
    <sui-container v-if="this.showFiltersForm">
      <sui-form class="filters-form" @submit.prevent="applyFilters">
        ...
        <sui-form-fields>
          ...
          <sui-form-field v-if="showFilterTime && (filter.time.group == 'day' && showFilterTimeGroup)" width="six">
          ...
          <sui-form-field v-if="showFilterTime && filter.time.group == 'week'" width="seven">
            <label>{{$t('filter.time_interval')}}</label>
            <sui-button-group class="fluid">
              <sui-button
                :active="filter.time.range == 'last_week'"
          ...
          <sui-form-field v-if="showFilterTime && filter.time.group == 'month'" width="six">
            <label>{{$t('filter.time_interval')}}</label>
            <sui-button-group class="fluid">
              <sui-button
                :active="filter.time.range == 'last_month'"
          ...
          <sui-form-field v-if="showFilterTime && filter.time.group == 'year'" width="six">
            <label>{{$t('filter.time_interval')}}</label>
            <sui-button-group class="fluid">
              <sui-button
